...
const Patient = () => {
    ...
    return (
        ...
        >
            ...
            <main className={`flex-1 pt-16 overflow-auto transition-all duration-200 ease-in-out
                                ...
                                <CardContent>
                                    <div className="grid gap-4 md:grid-cols-2">
                                        ...
                                        <div className={`flex items-center ${
                                            ...
                                            <span className="ml-2 truncate">{patientInfo.email}</span>
                                        </div>
                                        {patientInfo.phoneNo && (
                                            <div className={`flex items-center ${
                                                theme === "light" ? "text-gray-600" : ""
                            ...
                            {!patientInfo.bloodType && (
                                <Alert variant="default" className="mt-4">
                                    ...
                                    <AlertDescription className="text-red-500">
                                        Please update your profile to include your blood type. This information is crucial for accurate blood requests and potential emergencies.
                                    </AlertDescription>
                                </Alert>
                            )}
                        </motion.div>
